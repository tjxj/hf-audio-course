  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: 'chapter3',
          autogenerate: { directory: 'chapter3' },
        },
        {
          label: 'chapter4',
          autogenerate: { directory: 'chapter4' },
        },
        {
          label: 'chapter5',
          badge: 'New',
          autogenerate: { directory: 'chapter5' },
    
        },
        {
          label: 'chapter6',
          autogenerate: { directory: 'chapter6' },
        },
        {
          label: 'chapter7',
          autogenerate: { directory: 'chapter7' },
        },
        {
          label: 'chapter8',
          badge: 'New',
          autogenerate: { directory: 'chapter8' },
        },
      ],
    }),
  ],
